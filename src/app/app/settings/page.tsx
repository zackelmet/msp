...
export default function SettingsPage() {
  ...
  const inputCls =
    "w-full bg-[#0a141f] border border-[#4590e2]/20 rounded-lg px-3 py-2 text-sm text-white placeholder-[#7a9bb5] focus:outline-none focus:border-[#4590e2]/60 transition-colors disabled:opacity-50 cursor-not-allowed font-mono";
      ...
      <div className="bg-[#0d1e30] border border-red-500/20 rounded-xl p-6 space-y-4">
        ...
        {deleteStep === "confirm" && (
          <div className="space-y-4 pt-2 border-t border-red-500/10">
            ...
            <p className="text-xs text-[#7a9bb5]">
              This will permanently delete your account, all target groups,
              scheduled tests, and pentest data.
            </p>
