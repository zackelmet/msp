  ...
  return (
    <div className="p-6 lg:p-8 space-y-8 max-w-4xl mx-auto">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-sm text-[#7a9bb5]">
                Put a card on file so your monthly usage auto-charges. No charge
                now — you&apos;re billed at month-end on actual consumption.
              </p>
              <button
      ...
      <div className="flex items-start gap-3 text-xs text-[#7a9bb5] bg-[#4590e2]/5 border border-[#4590e2]/15 rounded-xl p-4">
        ...
        />
        <p>
          Graduated example: 1,500 IPs in a month = 100×$17 + 900×$14 + 500×$10
          = <b className="text-white">$19,300</b> (~$12.87 / IP effective).
        </p>
      </div>
    </div>
  );
